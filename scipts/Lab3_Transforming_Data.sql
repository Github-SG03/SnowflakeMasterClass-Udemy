// Create a Schema named 'external_stage' as External Stages
CREATE OR REPLACE SCHEMA MYDB.external_stages;

// Create a Schema named 'file_formats'to keep all file formats
CREATE SCHEMA IF NOT EXISTS MYDB.file_formats;

//Creating file format object
CREATE OR REPLACE FILE FORMAT MYDB.file_formats.csv_file_format;

//Description of  format object 'csv_file_formats'
DESC FILE FORMAT MYDB.file_formats.csv_file_format

// Publicly accessible staging area/ Creating a external stage object   
